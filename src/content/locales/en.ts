export default {
  ...
  "dictionary": {
    ...
    "projects": {
      ...
      "sub": "Real products, the problems they solved, and the numbers they moved. Explore each case study to see how the system was engineered end to end.",
