...
export const projectsData: ProjectSchema[] = [
  {
    ...
    en: {
      ...
      screens: [
        ...
        { id: 'history', title: 'Consumption History', description: 'Keep a structured record of meals and review consumption patterns over time.' },
        { id: 'goals', title: 'Health Goals', description: 'Connect nutritional reports to personal weight and health objectives.' },
        { id: 'insights', title: 'Eating Insights', description: 'Identify recurring consumption patterns and receive health-oriented alerts.' },
